...
- Lesson 7 = calibrate noisy Level 1 graders (triage true fail vs FP vs flake; harden `no-hypothyroid-diagnosis`; 3-trial agreement) before re-judging prompt promotion.
