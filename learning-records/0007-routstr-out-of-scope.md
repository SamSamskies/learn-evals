...
**Implications:** Do not teach Routstr wiring, cost-on-card for remote providers, or #8 as a gate. Next skills stay local: prompt-version bake-offs on `gemma4:26b`, then trend chat / richer graders / regression rituals as needed. Update [[MISSION.md]] accordingly.
